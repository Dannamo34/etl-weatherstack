...
# Ruta correcta al archivo CSV (desde scripts/)
DATA_PATH = "data/clima.csv"

# Verificar que el archivo exista
if not os.path.exists(DATA_PATH):
    print("❌ No se encontró data/clima.csv — ejecuta primero extractor.py")
    exit()
...
# Guardar imagen
plt.savefig('data/clima_analysis.png', dpi=300)
